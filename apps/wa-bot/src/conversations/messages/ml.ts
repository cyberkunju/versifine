...
export const ml: MessagePack = {
  ...
  frameCancelled: 'കുഴപ്പമില്ല — ഇനി എന്ത് ചെയ്യാം?',
  frameError: 'അത് നടന്നില്ല — ഒന്നുകൂടി ശ്രമിക്കാമോ? അല്ലെങ്കിൽ CANCEL ടൈപ്പ് ചെയ്ത് പുറത്ത് വരാം.',
  frameMaxRetriesSuffix: '\n\n(കുഴപ്പമില്ല — ഇത് തൽക്കാലം വിടാം. തയ്യാറാകുമ്പോൾ പുതിയ സന്ദേശം അയക്കൂ.)',
  nothingToConfirm: 'ഇപ്പോൾ ഉറപ്പിക്കാൻ ഒന്നുമില്ല — പക്ഷേ ഞാൻ ഇവിടെയുണ്ട്. ഒരു ചെലവ് എഴുതാം, ടോട്ടൽ ചോദിക്കാം, അല്ലെങ്കിൽ ഞാൻ എന്തൊക്കെ ചെയ്യുമെന്ന് നോക്കാം.',
  engineError: 'എന്റെ ഭാഗത്ത് ഒരു ചെറിയ പിശക് — അത് എന്റെ കുഴപ്പമാണ്, നിങ്ങളുടേതല്ല. നിങ്ങളുടെ സന്ദേശം സുരക്ഷിതമാണ്; ഒന്നുകൂടി അയക്കാമോ?',
  voiceUnclear: '🎤 അത് വ്യക്തമായി കേൾക്കാനായില്ല. ഒന്നുകൂടി പറയാമോ, അല്ലെങ്കിൽ ടൈപ്പ് ചെയ്യാമോ?',
  refNoMatch:
    'അയ്യോ, അത് കണ്ടെത്താനായില്ല. തുകയോ സ്ഥലമോ ദിവസമോ പറയൂ — ഉദാ "delete the ₹250 coffee" അല്ലെങ്കിൽ "change yesterday\'s lunch to 350" — ഞാൻ ശരിയാക്കാം.',
  refMultipleCandidates: (verb, list, count) => {
    const v = verb === 'delete' ? 'നീക്കം' : 'മാറ്റം';
    return `കുറച്ചെണ്ണം ചേരുന്നുണ്ട് — ഏതാണ് ${v} ചെയ്യേണ്ടത്?\n${list}\nനമ്പർ (1-${count}) അയക്കൂ, അല്ലെങ്കിൽ വേണ്ട എന്ന് പറയൂ.`;
  },
  refUpdateNeedsTarget: 'കണ്ടെത്തി — ഇത് എന്താക്കി മാറ്റണം?',
  refPickCancelled: 'കുഴപ്പമില്ല — ഉള്ളതുപോലെ വിട്ടു.',
  captureMissingDetail:
    'ഏതാണ്ട് ആയി — ഒരു വിവരം കൂടി, അത് രേഖപ്പെടും. ഇവിടെ അയക്കൂ, അല്ലെങ്കിൽ വേണ്ട എന്ന് പറയൂ.',
  imageAck: (seen) => {
  ...
  captureAsk: (needs) => {
    if (needs.includes('amount')) return 'മനസ്സിലായി — എത്രയായിരുന്നു?';
    if (needs.includes('description')) return 'ശരി — എന്തിനായിരുന്നു?';
    if (needs.includes('wallet')) return 'ഏത് അക്കൗണ്ട്/വാലറ്റ് ഉപയോഗിച്ചു?';
    if (needs.includes('currency')) return 'ഏത് കറൻസിയായിരുന്നു?';
    return 'ഒരു കാര്യം കൂടി — എന്തിനായിരുന്നു?';
  },

  captureCancelled: 'കുഴപ്പമില്ല — വിട്ടു, ഒന്നും സേവ് ചെയ്തിട്ടില്ല.',

  captureFailed: 'അയ്യോ, അത് സേവ് ആയില്ല — അത് എന്റെ ഭാഗത്താണ്, നിങ്ങളുടെ തെറ്റല്ല. ഒന്നുകൂടി ശ്രമിക്കാമോ?',
  ...
  stopAcknowledged: 'ശരി, ഞാൻ തൽക്കാലം നിർത്തുന്നു. വീണ്ടും തുടങ്ങാൻ എപ്പോൾ വേണമെങ്കിലും RESET അയക്കൂ.',

  unknown: "ഇത് ശരിയായി ചെയ്യണമെന്നുണ്ട്, പക്ഷേ നിങ്ങൾ എന്താണ് ഉദ്ദേശിച്ചതെന്ന് വ്യക്തമായില്ല. ഒരു ചെലവ് എഴുതാം ('200 chai'), ടോട്ടൽ ചോദിക്കാം, അല്ലെങ്കിൽ ഞാൻ എന്തൊക്കെ ചെയ്യുമെന്ന് നോക്കാം — പറഞ്ഞാൽ മതി.",

  error: 'എന്റെ ഭാഗത്ത് എന്തോ കുഴപ്പം — നിങ്ങളുടെ സന്ദേശം സുരക്ഷിതമാണ്. ഒന്നുകൂടി ശ്രമിക്കാമോ?',
