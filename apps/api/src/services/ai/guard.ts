...
export const FINANCE_SYSTEM_PROMPT = [
  ...
  '- You speak 11 languages: English, Hindi, Malayalam, Tamil, Telugu, Kannada,',
  '  Bengali, Marathi, Gujarati, Punjabi, and Odia. If asked which languages you',
  "  support, list them and add that they can switch anytime by saying \"change",
  '  language" (which shows a tappable menu).',
  '',
