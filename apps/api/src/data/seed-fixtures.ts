...
const VARIABLE: Array<Omit<Recurring, 'dayOfMonth'> & { weight: number }> = [
  { description: 'Swiggy order', category: 'Food Delivery', amount: 380, walletName: 'GPay UPI', weight: 6 },
  { description: 'Zomato dinner', category: 'Food Delivery', amount: 520, walletName: 'GPay UPI', weight: 4 },
  { description: 'BigBasket groceries', category: 'Groceries', amount: 1850, walletName: 'GPay UPI', weight: 3 },
  { description: 'Local kirana store', category: 'Groceries', amount: 420, walletName: 'Cash', weight: 4 },
  { description: 'Zepto express delivery', category: 'Convenience', amount: 250, walletName: 'GPay UPI', weight: 3 },
  { description: 'Auto rickshaw to office', category: 'Transportation', amount: 95, walletName: 'GPay UPI', weight: 5 },
  { description: 'Uber to airport', category: 'Transportation', amount: 480, walletName: 'GPay UPI', weight: 1 },
  { description: 'Rapido bike', category: 'Transportation', amount: 65, walletName: 'GPay UPI', weight: 4 },
  { description: 'Bengaluru Metro card top-up', category: 'Transportation', amount: 200, walletName: 'GPay UPI', weight: 1 },
  { description: 'BPCL fuel', category: 'Gas & Fuel', amount: 1200, walletName: 'ICICI Credit Card', weight: 2 },
  { description: 'Starbucks Indiranagar', category: 'Coffee & Beverages', amount: 320, walletName: 'ICICI Credit Card', weight: 3 },
  { description: 'Third Wave Coffee', category: 'Coffee & Beverages', amount: 220, walletName: 'GPay UPI', weight: 3 },
  { description: 'Cafe Coffee Day', category: 'Coffee & Beverages', amount: 180, walletName: 'GPay UPI', weight: 2 },
  { description: 'Truffles burger', category: 'Restaurants', amount: 850, walletName: 'ICICI Credit Card', weight: 2 },
  { description: 'Meghana Foods biryani', category: 'Restaurants', amount: 520, walletName: 'GPay UPI', weight: 2 },
  { description: 'Empire chicken', category: 'Fast Food', amount: 290, walletName: 'GPay UPI', weight: 2 },
  { description: 'KFC bucket', category: 'Fast Food', amount: 480, walletName: 'GPay UPI', weight: 1 },
  { description: 'Amazon order', category: 'Shopping & Retail', amount: 1499, walletName: 'ICICI Credit Card', weight: 2 },
  { description: 'Flipkart electronics', category: 'Shopping & Retail', amount: 2299, walletName: 'ICICI Credit Card', weight: 1 },
  { description: 'Apollo pharmacy', category: 'Healthcare', amount: 350, walletName: 'GPay UPI', weight: 1 },
  { description: 'BookMyShow movie', category: 'Entertainment', amount: 600, walletName: 'GPay UPI', weight: 1 },
  { description: 'Decathlon gear', category: 'Shopping & Retail', amount: 1850, walletName: 'ICICI Credit Card', weight: 1 },
];
