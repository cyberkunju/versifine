...
- (next) **item 3** — epistemic layer (negation/conditional/future) so phantom money can't be minted; especially important now the planner is live for compound text.
