...
- (next) **item 4** — FX resolution worker (P0-5): `needsFxResolution` is write-only; 5 OMR booked as ₹5 forever. OR item 1b (space-base summation). Both correctness-adjacent.
